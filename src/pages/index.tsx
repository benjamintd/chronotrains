...
const Home: NextPage = () => {
  ...
  const isochronesMap = useRef<LRUCache<number, FeatureCollection<Polygon | MultiPolygon, { duration: number }>>>(new LRUCache({ max: 300 }));
  ...
  return (
    <div className="relative w-screen h-screen">
      {!stationsData && <div className='absolute flex items-center justify-center w-full h-full bg-gray-700 bg-opacity-20'>
        <svg aria-hidden="true" className="w-8 h-8 mr-2 text-white animate-spin fill-gray-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
